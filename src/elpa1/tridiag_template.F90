...
!    my_stream = obj%gpu_setup%my_stream
!    call gpu_memcpy_async_and_stream_synchronize &
!            ("tridiag e_vec_dev -> e_vec", e_vec_dev, 0_c_intptr_t, &
!                                                 e_vec(1:na), &
!                                                 1, num, gpuMemcpyDeviceToHost, my_stream, .false., .false., .false.)
!#else
!    successGPU = gpu_memcpy(int(loc(e_vec(1)),kind=c_intptr_t),  e_vec_dev, &
!                              num, gpuMemcpyDeviceToHost)
...
!    my_stream = obj%gpu_setup%my_stream
!    call gpu_memcpy_async_and_stream_synchronize &
!            ("tridiag d_vec_dev -> d_vec", d_vec_dev, 0_c_intptr_t, &
!                                                 d_vec(1:na), &
!                                                 1, num, gpuMemcpyDeviceToHost, my_stream, .false., .false., .false.)
!#else
!    successGPU = gpu_memcpy(int(loc(d_vec(1)),kind=c_intptr_t), d_vec_dev, &
...
!    my_stream = obj%gpu_setup%my_stream
!    call gpu_memcpy_async_and_stream_synchronize &
!            ("tridiag tau_dev -> tau", tau_dev, 0_c_intptr_t, &
!                                                 tau(1:na), &
!                                                 1, num, gpuMemcpyDeviceToHost, my_stream, .false., .false., .false.)
!#else
