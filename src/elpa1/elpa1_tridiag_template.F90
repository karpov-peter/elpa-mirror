...
#include "../general/precision_kinds.F90"
  ...
  if (error .ne. ELPA_OK) then
    write(error_unit,*) "Problem getting size of mpi_comm_rows. Aborting..."
    success = .false.
    call obj%timer%stop("tridiag_&
    &MATH_DATATYPE&
    &" // &
  ...
  if (error .ne. ELPA_OK) then
    write(error_unit,*) "Problem getting rank of mpi_comm_rows. Aborting..."
    success = .false.
    call obj%timer%stop("tridiag_&
    &MATH_DATATYPE&
    &" // &
  ...
  if (error .ne. ELPA_OK) then
    write(error_unit,*) "Problem getting size of mpi_comm_cols. Aborting..."
    success = .false.
    call obj%timer%stop("tridiag_&
    &MATH_DATATYPE&
    &" // &
  ...
  if (error .ne. ELPA_OK) then
    write(error_unit,*) "Problem getting rank of mpi_comm_cols. Aborting..."
    success = .false.
    call obj%timer%stop("tridiag_&
    &MATH_DATATYPE&
    &" // &
