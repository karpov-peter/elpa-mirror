...
(obj, a_mat, lda, na, nblk, nbw, matrixCols, mpi_comm_rows, mpi_comm_cols, mpi_comm_all, &
 ab, success)
  ...
  if (error .ne. ELPA_OK) then
    write(error_unit,*) "Problem getting rank of mpi_comm_parent in elpa2_redist_band. Aborting..."
    call obj%timer%stop("redist_band_&
    &MATH_DATATYPE&
    &" // &
    &PRECISION_SUFFIX &
  ...
  if (error .ne. ELPA_OK) then
    write(error_unit,*) "Problem getting size of mpi_comm_parent in elpa2_redist_band. Aborting..."
    call obj%timer%stop("redist_band_&
    &MATH_DATATYPE&
    &" // &
    &PRECISION_SUFFIX &
  ...
  if (error .ne. ELPA_OK) then
    write(error_unit,*) "Problem getting rank of mpi_comm_prow in elpa2_redist_band. Aborting..."
    call obj%timer%stop("redist_band_&
    &MATH_DATATYPE&
    &" // &
    &PRECISION_SUFFIX &
  ...
  if (error .ne. ELPA_OK) then
    write(error_unit,*) "Problem getting size of mpi_comm_row in elpa2_redist_band. Aborting..."
    call obj%timer%stop("redist_band_&
    &MATH_DATATYPE&
    &" // &
    &PRECISION_SUFFIX &
  ...
  if (error .ne. ELPA_OK) then
    write(error_unit,*) "Problem getting rank of mpi_comm_col in elpa2_redist_band. Aborting..."
    call obj%timer%stop("redist_band_&
    &MATH_DATATYPE&
    &" // &
    &PRECISION_SUFFIX &
  ...
  if (error .ne. ELPA_OK) then
    write(error_unit,*) "Problem getting size of mpi_comm_col in elpa2_redist_band. Aborting..."
    call obj%timer%stop("redist_band_&
    &MATH_DATATYPE&
    &" // &
    &PRECISION_SUFFIX &
