...
#include "../general/precision_kinds.F90"
  ...
  if (error .ne. ELPA_OK) then
    write(error_unit,*) "Problem getting size of mpi_comm_rows in elpa2_band_to_full. Aborting..."
    success = .false.
    call obj%timer%stop("trans_ev_band_to_full_&
    &MATH_DATATYPE&
    &" // &
  ...
  if (error .ne. ELPA_OK) then
    write(error_unit,*) "Problem getting rank of mpi_comm_rows in elpa2_band_to_full. Aborting..."
    success = .false.
    call obj%timer%stop("trans_ev_band_to_full_&
    &MATH_DATATYPE&
    &" // &
  ...
  if (error .ne. ELPA_OK) then
    write(error_unit,*) "Problem getting size of mpi_comm_cols in elpa2_band_to_full. Aborting..."
    success = .false.
    call obj%timer%stop("trans_ev_band_to_full_&
    &MATH_DATATYPE&
    &" // &
  ...
  if (error .ne. ELPA_OK) then
    write(error_unit,*) "Problem getting rank of mpi_comm_cols in elpa2_band_to_full. Aborting..."
    success = .false.
    call obj%timer%stop("trans_ev_band_to_full_&
    &MATH_DATATYPE&
    &" // &
